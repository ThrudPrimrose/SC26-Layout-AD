#!/usr/bin/env bash
# Submit run_beverin.sh for E0_NUMA, E1_MatrixAdd, ..., E5_USXX.
...
#
# Usage:  bash submit_all_beverin.sh [E0 E1 ...]
...
jobs_log="${SCRIPT_DIR}/.submit_beverin_jobs.log"
: >"${jobs_log}"
...
if [[ "${DRY_RUN:-0}" != "1" ]]; then
    echo
    echo "[submit_all_beverin] queue snapshot:"
