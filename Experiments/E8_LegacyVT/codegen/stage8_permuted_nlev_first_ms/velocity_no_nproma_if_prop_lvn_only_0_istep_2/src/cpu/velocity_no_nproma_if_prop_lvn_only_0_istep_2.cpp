...
static void gpu_timer_split(velocity_no_nproma_if_prop_lvn_only_0_istep_2_state_t* __state){
...
inline void loop_body_7_0_36(velocity_no_nproma_if_prop_lvn_only_0_istep_2_state_t *__state, const int&  __CG_global_data__m_nproma, int* __restrict__ __CG_p_patch__CG_cells__m_end_index, int* __restrict__ __CG_p_patch__CG_cells__m_start_index, const double&  cfl_w_limit, const double&  dtime, double * __restrict__ gpu___CG_p_diag__m_w_concorr_c, double * __restrict__ gpu___CG_p_int__m_e_bln_c_s, double * __restrict__ gpu___CG_p_int__m_geofac_n2s, double * __restrict__ gpu___CG_p_metrics__m_coeff1_dwdz, double * __restrict__ gpu___CG_p_metrics__m_coeff2_dwdz, double * __restrict__ gpu___CG_p_metrics__m_ddqz_z_half, int * __restrict__ gpu___CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask, double * __restrict__ gpu___CG_p_patch__CG_cells__m_area, uint8_t * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_blk_uint8, uint16_t * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_idx_uint16, uint16_t * __restrict__ gpu___CG_p_patch__CG_cells__m_neighbor_idx_uint16, double * __restrict__ gpu___CG_p_prog__m_w, double * __restrict__ gpu_z_kin_hor_e, double * __restrict__ gpu_z_v_grad_w, const double&  scalfac_exdiff, double * __restrict__ gpu___CG_p_diag__m_ddt_w_adv_pc, uint8_t * __restrict__ gpu_cfl_clipping, uint8_t * __restrict__ gpu_levmask, double * __restrict__ gpu_maxvcfl_arr, double * __restrict__ gpu_vcflmax, double * __restrict__ gpu_z_ekinh, double * __restrict__ gpu_z_w_con_c, double * __restrict__ gpu_z_w_con_c_full, int __f2dace_A_z_kin_hor_e_d_0_s, int __f2dace_A_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_0_s, int __f2dace_OA_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_2_s, int _for_it_22, int i_endblk_2, int i_endblk_var_147, int i_startblk_2, int i_startblk_var_146, int nflatlev_jg, int nrdmax_jg, int ntnd, int tmp_struct_symbol_10, int tmp_struct_symbol_2, int tmp_struct_symbol_4) {
...

    {
        ...
        __dace_runkernel_single_state_body_4_map_1_1_31_5_6(__state, gpu_cfl_clipping, gpu_levmask, _for_it_22, nrdmax_jg);
        ...
        __dace_runkernel_single_state_body_5_map_1_1_31_5_16(__state, gpu_z_w_con_c, gpu_z_w_con_c_full, _for_it_22, i_endidx_var_149, i_startidx_var_148, tmp_struct_symbol_2);
        {
            int size;
...
inline void loop_body_70_0_36(velocity_no_nproma_if_prop_lvn_only_0_istep_2_state_t *__state, const int&  __CG_global_data__m_nproma, int* __restrict__ __CG_p_patch__CG_cells__m_end_index, int* __restrict__ __CG_p_patch__CG_cells__m_start_index, const double&  cfl_w_limit, const double&  dtime, double * __restrict__ gpu___CG_p_diag__m_w_concorr_c, double * __restrict__ gpu___CG_p_int__m_e_bln_c_s, double * __restrict__ gpu___CG_p_int__m_geofac_n2s, double * __restrict__ gpu___CG_p_metrics__m_coeff1_dwdz, double * __restrict__ gpu___CG_p_metrics__m_coeff2_dwdz, double * __restrict__ gpu___CG_p_metrics__m_ddqz_z_half, int * __restrict__ gpu___CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask, double * __restrict__ gpu___CG_p_patch__CG_cells__m_area, uint8_t * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_blk_uint8, int * __restrict__ gpu___CG_p_patch__CG_cells__m_edge_idx, int * __restrict__ gpu___CG_p_patch__CG_cells__m_neighbor_idx, double * __restrict__ gpu___CG_p_prog__m_w, double * __restrict__ gpu_z_kin_hor_e, double * __restrict__ gpu_z_v_grad_w, const double&  scalfac_exdiff, double * __restrict__ gpu___CG_p_diag__m_ddt_w_adv_pc, uint8_t * __restrict__ gpu_cfl_clipping, uint8_t * __restrict__ gpu_levmask, double * __restrict__ gpu_maxvcfl_arr, double * __restrict__ gpu_vcflmax, double * __restrict__ gpu_z_ekinh, double * __restrict__ gpu_z_w_con_c, double * __restrict__ gpu_z_w_con_c_full, int __f2dace_A_z_kin_hor_e_d_0_s, int __f2dace_A_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_0_s, int __f2dace_OA_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_2_s, int _for_it_22, int i_endblk_2, int i_endblk_var_147, int i_startblk_2, int i_startblk_var_146, int nflatlev_jg, int nrdmax_jg, int ntnd, int tmp_struct_symbol_10, int tmp_struct_symbol_2, int tmp_struct_symbol_4) {
...

    {
        ...
        __dace_runkernel_single_state_body_4_map_1_1_94_5_6(__state, gpu_cfl_clipping, gpu_levmask, _for_it_22, nrdmax_jg);
        ...
        __dace_runkernel_single_state_body_5_map_1_1_94_5_16(__state, gpu_z_w_con_c, gpu_z_w_con_c_full, _for_it_22, i_endidx_var_149, i_startidx_var_148, tmp_struct_symbol_2);
        {
            int size;
...
void __program_velocity_no_nproma_if_prop_lvn_only_0_istep_2_internal(velocity_no_nproma_if_prop_lvn_only_0_istep_2_state_t*__state, global_data_type* global_data, t_nh_diag* p_diag, t_int_state* p_int, t_nh_metrics* p_metrics, t_patch* p_patch, t_nh_prog* p_prog, double * __restrict__ z_kin_hor_e, double * __restrict__ z_vt_ie, double * __restrict__ z_w_concorr_me, int __f2dace_A_z_kin_hor_e_d_0_s, int __f2dace_A_z_kin_hor_e_d_1_s, int __f2dace_A_z_kin_hor_e_d_2_s, int __f2dace_A_z_vt_ie_d_0_s, int __f2dace_A_z_vt_ie_d_1_s, int __f2dace_A_z_vt_ie_d_2_s, int __f2dace_A_z_w_concorr_me_d_0_s, int __f2dace_A_z_w_concorr_me_d_1_s, int __f2dace_A_z_w_concorr_me_d_2_s, int __f2dace_OA_z_kin_hor_e_d_0_s, int __f2dace_OA_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_2_s, int __f2dace_OA_z_vt_ie_d_0_s, int __f2dace_OA_z_vt_ie_d_1_s, int __f2dace_OA_z_vt_ie_d_2_s, int __f2dace_OA_z_w_concorr_me_d_0_s, int __f2dace_OA_z_w_concorr_me_d_1_s, int __f2dace_OA_z_w_concorr_me_d_2_s, double dt_linintp_ubc, double dtime, int istep, int ldeepatmo, int lvn_only, int ntnd)
{
    ...
    double * permuted_gpu___CG_p_diag__m_ddt_w_adv_pc;
    DACE_GPU_CHECK(cudaMalloc((void**)&permuted_gpu___CG_p_diag__m_ddt_w_adv_pc, (((((91 * __f2dace_SA_ddt_w_adv_pc_d_0_s_p_diag_9) * __f2dace_SA_ddt_w_adv_pc_d_2_s_p_diag_9) * (__f2dace_SA_ddt_w_adv_pc_d_3_s_p_diag_9 - 1)) + ((91 * __f2dace_SA_ddt_w_adv_pc_d_0_s_p_diag_9) * (__f2dace_SA_ddt_w_adv_pc_d_2_s_p_diag_9 - 1))) + (91 * __f2dace_SA_ddt_w_adv_pc_d_0_s_p_diag_9)) * sizeof(double)));
    ...
    double * permuted_gpu___CG_p_metrics__m_coeff1_dwdz;
    DACE_GPU_CHECK(cudaMalloc((void**)&permuted_gpu___CG_p_metrics__m_coeff1_dwdz, (((90 * __f2dace_SA_coeff1_dwdz_d_0_s_p_metrics_8) * (__f2dace_SA_coeff1_dwdz_d_2_s_p_metrics_8 - 1)) + (90 * __f2dace_SA_coeff1_dwdz_d_0_s_p_metrics_8)) * sizeof(double)));
    double * permuted_gpu___CG_p_metrics__m_coeff2_dwdz;
    DACE_GPU_CHECK(cudaMalloc((void**)&permuted_gpu___CG_p_metrics__m_coeff2_dwdz, (((90 * __f2dace_SA_coeff2_dwdz_d_0_s_p_metrics_8) * (__f2dace_SA_coeff2_dwdz_d_2_s_p_metrics_8 - 1)) + (90 * __f2dace_SA_coeff2_dwdz_d_0_s_p_metrics_8)) * sizeof(double)));
    ...
    int * permuted_gpu___CG_p_patch__CG_cells__m_neighbor_blk;
    DACE_GPU_CHECK(cudaMalloc((void**)&permuted_gpu___CG_p_patch__CG_cells__m_neighbor_blk, ((((__f2dace_SA_neighbor_blk_d_0_s_cells_p_patch_2 * __f2dace_SA_neighbor_blk_d_2_s_cells_p_patch_2) * (__f2dace_SA_neighbor_blk_d_1_s_cells_p_patch_2 - 1)) + (__f2dace_SA_neighbor_blk_d_0_s_cells_p_patch_2 * (__f2dace_SA_neighbor_blk_d_2_s_cells_p_patch_2 - 1))) + __f2dace_SA_neighbor_blk_d_0_s_cells_p_patch_2) * sizeof(int)));
    int * permuted_gpu___CG_p_patch__CG_cells__m_neighbor_idx;
    DACE_GPU_CHECK(cudaMalloc((void**)&permuted_gpu___CG_p_patch__CG_cells__m_neighbor_idx, ((((__f2dace_SA_neighbor_idx_d_0_s_cells_p_patch_2 * __f2dace_SA_neighbor_idx_d_2_s_cells_p_patch_2) * (__f2dace_SA_neighbor_idx_d_1_s_cells_p_patch_2 - 1)) + (__f2dace_SA_neighbor_idx_d_0_s_cells_p_patch_2 * (__f2dace_SA_neighbor_idx_d_2_s_cells_p_patch_2 - 1))) + __f2dace_SA_neighbor_idx_d_0_s_cells_p_patch_2) * sizeof(int)));
    ...
    int * permuted_gpu___CG_p_patch__CG_verts__m_cell_blk;
    DACE_GPU_CHECK(cudaMalloc((void**)&permuted_gpu___CG_p_patch__CG_verts__m_cell_blk, ((((__f2dace_SA_cell_blk_d_0_s_verts_p_patch_5 * __f2dace_SA_cell_blk_d_2_s_verts_p_patch_5) * (__f2dace_SA_cell_blk_d_1_s_verts_p_patch_5 - 1)) + (__f2dace_SA_cell_blk_d_0_s_verts_p_patch_5 * (__f2dace_SA_cell_blk_d_2_s_verts_p_patch_5 - 1))) + __f2dace_SA_cell_blk_d_0_s_verts_p_patch_5) * sizeof(int)));
...

    {
        ...
        __dace_runkernel_permute_gpu___CG_p_diag__m_ddt_vn_apc_pc_to_permuted_gpu___CG_p_diag__m_ddt_vn_apc_pc_map_1_1_0_11_0(__state, gpu___CG_p_diag__m_ddt_vn_apc_pc, permuted_gpu___CG_p_diag__m_ddt_vn_apc_pc, __f2dace_SA_ddt_vn_apc_pc_d_0_s_p_diag_9, __f2dace_SA_ddt_vn_apc_pc_d_2_s_p_diag_9, __f2dace_SA_ddt_vn_apc_pc_d_3_s_p_diag_9);
        __dace_runkernel_permute_gpu___CG_p_diag__m_ddt_w_adv_pc_to_permuted_gpu___CG_p_diag__m_ddt_w_adv_pc_map_1_1_0_11_5(__state, gpu___CG_p_diag__m_ddt_w_adv_pc, permuted_gpu___CG_p_diag__m_ddt_w_adv_pc, __f2dace_SA_ddt_w_adv_pc_d_0_s_p_diag_9, __f2dace_SA_ddt_w_adv_pc_d_2_s_p_diag_9, __f2dace_SA_ddt_w_adv_pc_d_3_s_p_diag_9);
        __dace_runkernel_permute_gpu___CG_p_diag__m_vn_ie_to_permuted_gpu___CG_p_diag__m_vn_ie_map_1_1_0_11_10(__state, gpu___CG_p_diag__m_vn_ie, permuted_gpu___CG_p_diag__m_vn_ie, __f2dace_SA_vn_ie_d_0_s_p_diag_9, __f2dace_SA_vn_ie_d_2_s_p_diag_9);
        __dace_runkernel_permute_gpu___CG_p_diag__m_vt_to_permuted_gpu___CG_p_diag__m_vt_map_1_1_0_11_15(__state, gpu___CG_p_diag__m_vt, permuted_gpu___CG_p_diag__m_vt, __f2dace_SA_vt_d_0_s_p_diag_9, __f2dace_SA_vt_d_2_s_p_diag_9);
        __dace_runkernel_permute_gpu___CG_p_diag__m_w_concorr_c_to_permuted_gpu___CG_p_diag__m_w_concorr_c_map_1_1_0_11_20(__state, gpu___CG_p_diag__m_w_concorr_c, permuted_gpu___CG_p_diag__m_w_concorr_c, __f2dace_SA_w_concorr_c_d_0_s_p_diag_9, __f2dace_SA_w_concorr_c_d_2_s_p_diag_9);
        __dace_runkernel_permute_gpu___CG_p_metrics__m_coeff1_dwdz_to_permuted_gpu___CG_p_metrics__m_coeff1_dwdz_map_1_1_0_11_25(__state, gpu___CG_p_metrics__m_coeff1_dwdz, permuted_gpu___CG_p_metrics__m_coeff1_dwdz, __f2dace_SA_coeff1_dwdz_d_0_s_p_metrics_8, __f2dace_SA_coeff1_dwdz_d_2_s_p_metrics_8);
        __dace_runkernel_permute_gpu___CG_p_metrics__m_coeff2_dwdz_to_permuted_gpu___CG_p_metrics__m_coeff2_dwdz_map_1_1_0_11_30(__state, gpu___CG_p_metrics__m_coeff2_dwdz, permuted_gpu___CG_p_metrics__m_coeff2_dwdz, __f2dace_SA_coeff2_dwdz_d_0_s_p_metrics_8, __f2dace_SA_coeff2_dwdz_d_2_s_p_metrics_8);
        __dace_runkernel_permute_gpu___CG_p_metrics__m_coeff_gradekin_to_permuted_gpu___CG_p_metrics__m_coeff_gradekin_map_1_1_0_11_35(__state, gpu___CG_p_metrics__m_coeff_gradekin, permuted_gpu___CG_p_metrics__m_coeff_gradekin, __f2dace_SA_coeff_gradekin_d_0_s_p_metrics_8, __f2dace_SA_coeff_gradekin_d_1_s_p_metrics_8, __f2dace_SA_coeff_gradekin_d_2_s_p_metrics_8);
        __dace_runkernel_permute_gpu___CG_p_metrics__m_ddqz_z_full_e_to_permuted_gpu___CG_p_metrics__m_ddqz_z_full_e_map_1_1_0_11_40(__state, gpu___CG_p_metrics__m_ddqz_z_full_e, permuted_gpu___CG_p_metrics__m_ddqz_z_full_e, __f2dace_SA_ddqz_z_full_e_d_0_s_p_metrics_8, __f2dace_SA_ddqz_z_full_e_d_2_s_p_metrics_8);
        __dace_runkernel_permute_gpu___CG_p_metrics__m_ddqz_z_half_to_permuted_gpu___CG_p_metrics__m_ddqz_z_half_map_1_1_0_11_45(__state, gpu___CG_p_metrics__m_ddqz_z_half, permuted_gpu___CG_p_metrics__m_ddqz_z_half, __f2dace_SA_ddqz_z_half_d_0_s_p_metrics_8, __f2dace_SA_ddqz_z_half_d_2_s_p_metrics_8);
        __dace_runkernel_permute_gpu___CG_p_patch__CG_cells__m_edge_blk_to_permuted_gpu___CG_p_patch__CG_cells__m_edge_blk_map_1_1_0_11_50(__state, gpu___CG_p_patch__CG_cells__m_edge_blk, permuted_gpu___CG_p_patch__CG_cells__m_edge_blk, __f2dace_SA_edge_blk_d_0_s_cells_p_patch_2, __f2dace_SA_edge_blk_d_1_s_cells_p_patch_2, __f2dace_SA_edge_blk_d_2_s_cells_p_patch_2);
        __dace_runkernel_permute_gpu___CG_p_patch__CG_cells__m_edge_idx_to_permuted_gpu___CG_p_patch__CG_cells__m_edge_idx_map_1_1_0_11_55(__state, gpu___CG_p_patch__CG_cells__m_edge_idx, permuted_gpu___CG_p_patch__CG_cells__m_edge_idx, __f2dace_SA_edge_idx_d_0_s_cells_p_patch_2, __f2dace_SA_edge_idx_d_1_s_cells_p_patch_2, __f2dace_SA_edge_idx_d_2_s_cells_p_patch_2);
        __dace_runkernel_permute_gpu___CG_p_patch__CG_cells__m_neighbor_blk_to_permuted_gpu___CG_p_patch__CG_cells__m_neighbor_blk_map_1_1_0_11_60(__state, gpu___CG_p_patch__CG_cells__m_neighbor_blk, permuted_gpu___CG_p_patch__CG_cells__m_neighbor_blk, __f2dace_SA_neighbor_blk_d_0_s_cells_p_patch_2, __f2dace_SA_neighbor_blk_d_1_s_cells_p_patch_2, __f2dace_SA_neighbor_blk_d_2_s_cells_p_patch_2);
        __dace_runkernel_permute_gpu___CG_p_patch__CG_cells__m_neighbor_idx_to_permuted_gpu___CG_p_patch__CG_cells__m_neighbor_idx_map_1_1_0_11_65(__state, gpu___CG_p_patch__CG_cells__m_neighbor_idx, permuted_gpu___CG_p_patch__CG_cells__m_neighbor_idx, __f2dace_SA_neighbor_idx_d_0_s_cells_p_patch_2, __f2dace_SA_neighbor_idx_d_1_s_cells_p_patch_2, __f2dace_SA_neighbor_idx_d_2_s_cells_p_patch_2);
        __dace_runkernel_permute_gpu___CG_p_patch__CG_edges__m_cell_blk_to_permuted_gpu___CG_p_patch__CG_edges__m_cell_blk_map_1_1_0_11_70(__state, gpu___CG_p_patch__CG_edges__m_cell_blk, permuted_gpu___CG_p_patch__CG_edges__m_cell_blk, __f2dace_SA_cell_blk_d_0_s_edges_p_patch_4, __f2dace_SA_cell_blk_d_1_s_edges_p_patch_4, __f2dace_SA_cell_blk_d_2_s_edges_p_patch_4);
        __dace_runkernel_permute_gpu___CG_p_patch__CG_edges__m_cell_idx_to_permuted_gpu___CG_p_patch__CG_edges__m_cell_idx_map_1_1_0_11_75(__state, gpu___CG_p_patch__CG_edges__m_cell_idx, permuted_gpu___CG_p_patch__CG_edges__m_cell_idx, __f2dace_SA_cell_idx_d_0_s_edges_p_patch_4, __f2dace_SA_cell_idx_d_1_s_edges_p_patch_4, __f2dace_SA_cell_idx_d_2_s_edges_p_patch_4);
        __dace_runkernel_permute_gpu___CG_p_patch__CG_edges__m_quad_blk_to_permuted_gpu___CG_p_patch__CG_edges__m_quad_blk_map_1_1_0_11_80(__state, gpu___CG_p_patch__CG_edges__m_quad_blk, permuted_gpu___CG_p_patch__CG_edges__m_quad_blk, __f2dace_SA_quad_blk_d_0_s_edges_p_patch_4, __f2dace_SA_quad_blk_d_1_s_edges_p_patch_4, __f2dace_SA_quad_blk_d_2_s_edges_p_patch_4);
        __dace_runkernel_permute_gpu___CG_p_patch__CG_edges__m_quad_idx_to_permuted_gpu___CG_p_patch__CG_edges__m_quad_idx_map_1_1_0_11_85(__state, gpu___CG_p_patch__CG_edges__m_quad_idx, permuted_gpu___CG_p_patch__CG_edges__m_quad_idx, __f2dace_SA_quad_idx_d_0_s_edges_p_patch_4, __f2dace_SA_quad_idx_d_1_s_edges_p_patch_4, __f2dace_SA_quad_idx_d_2_s_edges_p_patch_4);
        __dace_runkernel_permute_gpu___CG_p_patch__CG_edges__m_vertex_blk_to_permuted_gpu___CG_p_patch__CG_edges__m_vertex_blk_map_1_1_0_11_90(__state, gpu___CG_p_patch__CG_edges__m_vertex_blk, permuted_gpu___CG_p_patch__CG_edges__m_vertex_blk, __f2dace_SA_vertex_blk_d_0_s_edges_p_patch_4, __f2dace_SA_vertex_blk_d_1_s_edges_p_patch_4, __f2dace_SA_vertex_blk_d_2_s_edges_p_patch_4);
        __dace_runkernel_permute_gpu___CG_p_patch__CG_edges__m_vertex_idx_to_permuted_gpu___CG_p_patch__CG_edges__m_vertex_idx_map_1_1_0_11_95(__state, gpu___CG_p_patch__CG_edges__m_vertex_idx, permuted_gpu___CG_p_patch__CG_edges__m_vertex_idx, __f2dace_SA_vertex_idx_d_0_s_edges_p_patch_4, __f2dace_SA_vertex_idx_d_1_s_edges_p_patch_4, __f2dace_SA_vertex_idx_d_2_s_edges_p_patch_4);
        __dace_runkernel_permute_gpu___CG_p_patch__CG_verts__m_cell_blk_to_permuted_gpu___CG_p_patch__CG_verts__m_cell_blk_map_1_1_0_11_100(__state, gpu___CG_p_patch__CG_verts__m_cell_blk, permuted_gpu___CG_p_patch__CG_verts__m_cell_blk, __f2dace_SA_cell_blk_d_0_s_verts_p_patch_5, __f2dace_SA_cell_blk_d_1_s_verts_p_patch_5, __f2dace_SA_cell_blk_d_2_s_verts_p_patch_5);
        __dace_runkernel_permute_gpu___CG_p_prog__m_vn_to_permuted_gpu___CG_p_prog__m_vn_map_1_1_0_11_105(__state, gpu___CG_p_prog__m_vn, permuted_gpu___CG_p_prog__m_vn, __f2dace_SA_vn_d_0_s_p_prog_7, __f2dace_SA_vn_d_2_s_p_prog_7);
        __dace_runkernel_permute_gpu___CG_p_prog__m_w_to_permuted_gpu___CG_p_prog__m_w_map_1_1_0_11_110(__state, gpu___CG_p_prog__m_w, permuted_gpu___CG_p_prog__m_w, __f2dace_SA_w_d_0_s_p_prog_7, __f2dace_SA_w_d_2_s_p_prog_7);
        __dace_runkernel_permute_gpu_z_w_con_c_to_permuted_gpu_z_w_con_c_map_1_1_0_11_115(__state, __state->__0_gpu_z_w_con_c, __state->__0_permuted_gpu_z_w_con_c, tmp_struct_symbol_1);
        __dace_runkernel_permute_gpu_z_vt_ie_to_permuted_gpu_z_vt_ie_map_1_1_0_11_120(__state, gpu_z_vt_ie, permuted_gpu_z_vt_ie, __f2dace_A_z_vt_ie_d_0_s, __f2dace_A_z_vt_ie_d_1_s, __f2dace_A_z_vt_ie_d_2_s);
        __dace_runkernel_permute_gpu_z_w_concorr_me_to_permuted_gpu_z_w_concorr_me_map_1_1_0_11_125(__state, gpu_z_w_concorr_me, permuted_gpu_z_w_concorr_me, __f2dace_A_z_w_concorr_me_d_0_s, __f2dace_A_z_w_concorr_me_d_1_s, __f2dace_A_z_w_concorr_me_d_2_s);
        __dace_runkernel_permute_gpu_cfl_clipping_to_permuted_gpu_cfl_clipping_map_1_1_0_11_130(__state, __state->__0_gpu_cfl_clipping, __state->__0_permuted_gpu_cfl_clipping, tmp_struct_symbol_14);
        __dace_runkernel_permute_gpu_z_kin_hor_e_to_permuted_gpu_z_kin_hor_e_map_1_1_0_11_135(__state, gpu_z_kin_hor_e, permuted_gpu_z_kin_hor_e, __f2dace_A_z_kin_hor_e_d_0_s, __f2dace_A_z_kin_hor_e_d_1_s, __f2dace_A_z_kin_hor_e_d_2_s);
        __dace_runkernel_permute_gpu_z_v_grad_w_to_permuted_gpu_z_v_grad_w_map_1_1_0_11_140(__state, __state->__0_gpu_z_v_grad_w, __state->__0_permuted_gpu_z_v_grad_w, tmp_struct_symbol_4, tmp_struct_symbol_5);
        __dace_runkernel_permute_gpu_zeta_to_permuted_gpu_zeta_map_1_1_0_11_145(__state, __state->__0_gpu_zeta, __state->__0_permuted_gpu_zeta, tmp_struct_symbol_8, tmp_struct_symbol_9);
        __dace_runkernel_permute_gpu_maxvcfl_arr_to_permuted_gpu_maxvcfl_arr_map_1_1_0_11_150(__state, __state->__0_gpu_maxvcfl_arr, __state->__0_permuted_gpu_maxvcfl_arr, tmp_struct_symbol_11, tmp_struct_symbol_4);
        __dace_runkernel_permute_gpu_z_ekinh_to_permuted_gpu_z_ekinh_map_1_1_0_11_155(__state, __state->__0_gpu_z_ekinh, __state->__0_permuted_gpu_z_ekinh, tmp_struct_symbol_10, tmp_struct_symbol_11);
        __dace_runkernel_permute_gpu_z_w_v_to_permuted_gpu_z_w_v_map_1_1_0_11_160(__state, __state->__0_gpu_z_w_v, __state->__0_permuted_gpu_z_w_v, tmp_struct_symbol_6, tmp_struct_symbol_7);
        __dace_runkernel_permute_gpu_levmask_to_permuted_gpu_levmask_map_1_1_0_11_165(__state, __state->__0_gpu_levmask, __state->__0_permuted_gpu_levmask, tmp_struct_symbol_13);
        __dace_runkernel_permute_gpu_z_w_con_c_full_to_permuted_gpu_z_w_con_c_full_map_1_1_0_11_170(__state, __state->__0_gpu_z_w_con_c_full, __state->__0_permuted_gpu_z_w_con_c_full, tmp_struct_symbol_2, tmp_struct_symbol_3);
        DACE_GPU_CHECK(cudaStreamSynchronize(__state->gpu_context->streams[0]));
        ...
        if ((bitwidth_sym == 16)) {
            {
                ...
                __dace_runkernel_copy_map_gpu___CG_p_patch__CG_cells__m_neighbor_idx_to_gpu___CG_p_patch__CG_cells__m_neighbor_idx_uint16_1_1_4_0_5(__state, __state->__0_gpu___CG_p_patch__CG_cells__m_neighbor_idx_uint16, permuted_gpu___CG_p_patch__CG_cells__m_neighbor_idx, __f2dace_SA_neighbor_idx_d_0_s_cells_p_patch_2, __f2dace_SA_neighbor_idx_d_1_s_cells_p_patch_2, __f2dace_SA_neighbor_idx_d_2_s_cells_p_patch_2);
    ...
    if ((bitwidth_sym == 16)) {
        {
            ...
            }
            {
                for (auto _for_it_0_0_0 = i_startblk_var_140_0; _for_it_0_0_0 < (i_endblk_var_141_0 + 1); _for_it_0_0_0 += 1) {
                    loop_body_7_0_5(__state, __CG_global_data__m_nproma, &gpu___CG_p_int__m_cells_aw_verts[0], &__state->__0_gpu___CG_p_patch__CG_verts__m_cell_idx_uint16[0], &permuted_gpu___CG_p_prog__m_w[0], &__state->__0_permuted_gpu_z_w_v[0], _for_it_0_0_0, i_endblk_var_141_0, i_endidx_in_var_143_0, i_startblk_var_140_0, i_startidx_in_var_142_0, tmp_struct_symbol_6);
                }
            }
            {
            ...
            }
            {
                for (auto _for_it_16 = i_startblk_var_146; _for_it_16 < (i_endblk_var_147 + 1); _for_it_16 += 1) {
                    loop_body_7_0_28(__state, __CG_global_data__m_nproma, &__CG_p_patch__CG_edges__m_end_index[0], &__CG_p_patch__CG_edges__m_start_index[0], &permuted_gpu___CG_p_diag__m_vn_ie[0], &__state->__0_gpu___CG_p_patch__CG_edges__m_cell_idx_uint16[0], &gpu___CG_p_patch__CG_edges__m_inv_dual_edge_length[0], &gpu___CG_p_patch__CG_edges__m_inv_primal_edge_length[0], &gpu___CG_p_patch__CG_edges__m_tangent_orientation[0], &__state->__0_gpu___CG_p_patch__CG_edges__m_vertex_idx_uint16[0], &permuted_gpu___CG_p_prog__m_w[0], &permuted_gpu_z_vt_ie[0], &__state->__0_permuted_gpu_z_w_v[0], &__state->__0_permuted_gpu_z_v_grad_w[0], __f2dace_A_z_vt_ie_d_0_s, __f2dace_A_z_vt_ie_d_1_s, __f2dace_OA_z_vt_ie_d_0_s, __f2dace_OA_z_vt_ie_d_1_s, __f2dace_OA_z_vt_ie_d_2_s, _for_it_16, i_endblk_var_147, i_startblk_var_146, tmp_struct_symbol_4, tmp_struct_symbol_6);
                }
            }
            {
                for (auto _for_it_22 = replaced_var_0; _for_it_22 < (replaced_var_1 + 1); _for_it_22 += 1) {
                    loop_body_7_0_36(__state, __CG_global_data__m_nproma, &__CG_p_patch__CG_cells__m_end_index[0], &__CG_p_patch__CG_cells__m_start_index[0], cfl_w_limit, dtime, &permuted_gpu___CG_p_diag__m_w_concorr_c[0], &gpu___CG_p_int__m_e_bln_c_s[0], &gpu___CG_p_int__m_geofac_n2s[0], &permuted_gpu___CG_p_metrics__m_coeff1_dwdz[0], &permuted_gpu___CG_p_metrics__m_coeff2_dwdz[0], &permuted_gpu___CG_p_metrics__m_ddqz_z_half[0], &gpu___CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask[0], &gpu___CG_p_patch__CG_cells__m_area[0], &__state->__0_gpu___CG_p_patch__CG_cells__m_edge_blk_uint8[0], &__state->__0_gpu___CG_p_patch__CG_cells__m_edge_idx_uint16[0], &__state->__0_gpu___CG_p_patch__CG_cells__m_neighbor_idx_uint16[0], &permuted_gpu___CG_p_prog__m_w[0], &permuted_gpu_z_kin_hor_e[0], &__state->__0_permuted_gpu_z_v_grad_w[0], scalfac_exdiff, &permuted_gpu___CG_p_diag__m_ddt_w_adv_pc[0], &__state->__0_permuted_gpu_cfl_clipping[0], &__state->__0_permuted_gpu_levmask[0], &__state->__0_permuted_gpu_maxvcfl_arr[0], &__state->__0_gpu_vcflmax[0], &__state->__0_permuted_gpu_z_ekinh[0], &__state->__0_permuted_gpu_z_w_con_c[0], &__state->__0_permuted_gpu_z_w_con_c_full[0], __f2dace_A_z_kin_hor_e_d_0_s, __f2dace_A_z_kin_hor_e_d_1_s, __f2dace_OA_z_kin_hor_e_d_0_s, __f2dace_OA_z_kin_hor_e_d_1_s, __f2dace_OA_z_kin_hor_e_d_2_s, _for_it_22, i_endblk_2, replaced_var_1, i_startblk_2, replaced_var_0, nflatlev_jg, nrdmax_jg, ntnd, tmp_struct_symbol_10, tmp_struct_symbol_2, tmp_struct_symbol_4);
                }
            }
    ...
    } else if (((bitwidth_sym == 32) || (bitwidth_sym == 64))) {
        {
            ...
            {
                for (auto _for_it_16 = i_startblk_var_146; _for_it_16 < (i_endblk_var_147 + 1); _for_it_16 += 1) {
                    loop_body_70_0_28(__state, __CG_global_data__m_nproma, &__CG_p_patch__CG_edges__m_end_index[0], &__CG_p_patch__CG_edges__m_start_index[0], &permuted_gpu___CG_p_diag__m_vn_ie[0], &permuted_gpu___CG_p_patch__CG_edges__m_cell_idx[0], &gpu___CG_p_patch__CG_edges__m_inv_dual_edge_length[0], &gpu___CG_p_patch__CG_edges__m_inv_primal_edge_length[0], &gpu___CG_p_patch__CG_edges__m_tangent_orientation[0], &permuted_gpu___CG_p_patch__CG_edges__m_vertex_idx[0], &permuted_gpu___CG_p_prog__m_w[0], &permuted_gpu_z_vt_ie[0], &__state->__0_permuted_gpu_z_w_v[0], &__state->__0_permuted_gpu_z_v_grad_w[0], __f2dace_A_z_vt_ie_d_0_s, __f2dace_A_z_vt_ie_d_1_s, __f2dace_OA_z_vt_ie_d_0_s, __f2dace_OA_z_vt_ie_d_1_s, __f2dace_OA_z_vt_ie_d_2_s, _for_it_16, i_endblk_var_147, i_startblk_var_146, tmp_struct_symbol_4, tmp_struct_symbol_6);
                }
            }
            {
                for (auto _for_it_22 = replaced_var_0; _for_it_22 < (replaced_var_1 + 1); _for_it_22 += 1) {
                    loop_body_70_0_36(__state, __CG_global_data__m_nproma, &__CG_p_patch__CG_cells__m_end_index[0], &__CG_p_patch__CG_cells__m_start_index[0], cfl_w_limit, dtime, &permuted_gpu___CG_p_diag__m_w_concorr_c[0], &gpu___CG_p_int__m_e_bln_c_s[0], &gpu___CG_p_int__m_geofac_n2s[0], &permuted_gpu___CG_p_metrics__m_coeff1_dwdz[0], &permuted_gpu___CG_p_metrics__m_coeff2_dwdz[0], &permuted_gpu___CG_p_metrics__m_ddqz_z_half[0], &gpu___CG_p_patch__CG_cells__CG_decomp_info__m_owner_mask[0], &gpu___CG_p_patch__CG_cells__m_area[0], &__state->__0_gpu___CG_p_patch__CG_cells__m_edge_blk_uint8[0], &permuted_gpu___CG_p_patch__CG_cells__m_edge_idx[0], &permuted_gpu___CG_p_patch__CG_cells__m_neighbor_idx[0], &permuted_gpu___CG_p_prog__m_w[0], &permuted_gpu_z_kin_hor_e[0], &__state->__0_permuted_gpu_z_v_grad_w[0], scalfac_exdiff, &permuted_gpu___CG_p_diag__m_ddt_w_adv_pc[0], &__state->__0_permuted_gpu_cfl_clipping[0], &__state->__0_permuted_gpu_levmask[0], &__state->__0_permuted_gpu_maxvcfl_arr[0], &__state->__0_gpu_vcflmax[0], &__state->__0_permuted_gpu_z_ekinh[0], &__state->__0_permuted_gpu_z_w_con_c[0], &__state->__0_permuted_gpu_z_w_con_c_full[0], __f2dace_A_z_kin_hor_e_d_0_s, __f2dace_A_z_kin_hor_e_d_1_s, __f2dace_OA_z_kin_hor_e_d_0_s, __f2dace_OA_z_kin_hor_e_d_1_s, __f2dace_OA_z_kin_hor_e_d_2_s, _for_it_22, i_endblk_2, replaced_var_1, i_startblk_2, replaced_var_0, nflatlev_jg, nrdmax_jg, ntnd, tmp_struct_symbol_10, tmp_struct_symbol_2, tmp_struct_symbol_4);
                }
            }
            DACE_GPU_CHECK(cudaMemcpyAsync(__state->__0_vcflmax, __state->__0_gpu_vcflmax, tmp_struct_symbol_12 * sizeof(double), cudaMemcpyDeviceToHost, __state->gpu_context->streams[0]));
            {
...

    {
        ...
        __dace_runkernel_permute_permuted_gpu___CG_p_diag__m_ddt_vn_apc_pc_to_gpu___CG_p_diag__m_ddt_vn_apc_pc_map_1_1_0_12_0(__state, gpu___CG_p_diag__m_ddt_vn_apc_pc, permuted_gpu___CG_p_diag__m_ddt_vn_apc_pc, __f2dace_SA_ddt_vn_apc_pc_d_0_s_p_diag_9, __f2dace_SA_ddt_vn_apc_pc_d_2_s_p_diag_9, __f2dace_SA_ddt_vn_apc_pc_d_3_s_p_diag_9);
        __dace_runkernel_permute_permuted_gpu___CG_p_diag__m_ddt_w_adv_pc_to_gpu___CG_p_diag__m_ddt_w_adv_pc_map_1_1_0_12_5(__state, gpu___CG_p_diag__m_ddt_w_adv_pc, permuted_gpu___CG_p_diag__m_ddt_w_adv_pc, __f2dace_SA_ddt_w_adv_pc_d_0_s_p_diag_9, __f2dace_SA_ddt_w_adv_pc_d_2_s_p_diag_9, __f2dace_SA_ddt_w_adv_pc_d_3_s_p_diag_9);
        __dace_runkernel_permute_permuted_gpu___CG_p_diag__m_vn_ie_to_gpu___CG_p_diag__m_vn_ie_map_1_1_0_12_10(__state, gpu___CG_p_diag__m_vn_ie, permuted_gpu___CG_p_diag__m_vn_ie, __f2dace_SA_vn_ie_d_0_s_p_diag_9, __f2dace_SA_vn_ie_d_2_s_p_diag_9);
        __dace_runkernel_permute_permuted_gpu___CG_p_diag__m_vt_to_gpu___CG_p_diag__m_vt_map_1_1_0_12_15(__state, gpu___CG_p_diag__m_vt, permuted_gpu___CG_p_diag__m_vt, __f2dace_SA_vt_d_0_s_p_diag_9, __f2dace_SA_vt_d_2_s_p_diag_9);
        __dace_runkernel_permute_permuted_gpu___CG_p_diag__m_w_concorr_c_to_gpu___CG_p_diag__m_w_concorr_c_map_1_1_0_12_20(__state, gpu___CG_p_diag__m_w_concorr_c, permuted_gpu___CG_p_diag__m_w_concorr_c, __f2dace_SA_w_concorr_c_d_0_s_p_diag_9, __f2dace_SA_w_concorr_c_d_2_s_p_diag_9);
        __dace_runkernel_permute_permuted_gpu___CG_p_metrics__m_coeff1_dwdz_to_gpu___CG_p_metrics__m_coeff1_dwdz_map_1_1_0_12_25(__state, gpu___CG_p_metrics__m_coeff1_dwdz, permuted_gpu___CG_p_metrics__m_coeff1_dwdz, __f2dace_SA_coeff1_dwdz_d_0_s_p_metrics_8, __f2dace_SA_coeff1_dwdz_d_2_s_p_metrics_8);
        __dace_runkernel_permute_permuted_gpu___CG_p_metrics__m_coeff2_dwdz_to_gpu___CG_p_metrics__m_coeff2_dwdz_map_1_1_0_12_30(__state, gpu___CG_p_metrics__m_coeff2_dwdz, permuted_gpu___CG_p_metrics__m_coeff2_dwdz, __f2dace_SA_coeff2_dwdz_d_0_s_p_metrics_8, __f2dace_SA_coeff2_dwdz_d_2_s_p_metrics_8);
        __dace_runkernel_permute_permuted_gpu___CG_p_metrics__m_coeff_gradekin_to_gpu___CG_p_metrics__m_coeff_gradekin_map_1_1_0_12_35(__state, gpu___CG_p_metrics__m_coeff_gradekin, permuted_gpu___CG_p_metrics__m_coeff_gradekin, __f2dace_SA_coeff_gradekin_d_0_s_p_metrics_8, __f2dace_SA_coeff_gradekin_d_1_s_p_metrics_8, __f2dace_SA_coeff_gradekin_d_2_s_p_metrics_8);
        __dace_runkernel_permute_permuted_gpu___CG_p_metrics__m_ddqz_z_full_e_to_gpu___CG_p_metrics__m_ddqz_z_full_e_map_1_1_0_12_40(__state, gpu___CG_p_metrics__m_ddqz_z_full_e, permuted_gpu___CG_p_metrics__m_ddqz_z_full_e, __f2dace_SA_ddqz_z_full_e_d_0_s_p_metrics_8, __f2dace_SA_ddqz_z_full_e_d_2_s_p_metrics_8);
        __dace_runkernel_permute_permuted_gpu___CG_p_metrics__m_ddqz_z_half_to_gpu___CG_p_metrics__m_ddqz_z_half_map_1_1_0_12_45(__state, gpu___CG_p_metrics__m_ddqz_z_half, permuted_gpu___CG_p_metrics__m_ddqz_z_half, __f2dace_SA_ddqz_z_half_d_0_s_p_metrics_8, __f2dace_SA_ddqz_z_half_d_2_s_p_metrics_8);
        __dace_runkernel_permute_permuted_gpu___CG_p_patch__CG_cells__m_edge_blk_to_gpu___CG_p_patch__CG_cells__m_edge_blk_map_1_1_0_12_50(__state, gpu___CG_p_patch__CG_cells__m_edge_blk, permuted_gpu___CG_p_patch__CG_cells__m_edge_blk, __f2dace_SA_edge_blk_d_0_s_cells_p_patch_2, __f2dace_SA_edge_blk_d_1_s_cells_p_patch_2, __f2dace_SA_edge_blk_d_2_s_cells_p_patch_2);
        __dace_runkernel_permute_permuted_gpu___CG_p_patch__CG_cells__m_edge_idx_to_gpu___CG_p_patch__CG_cells__m_edge_idx_map_1_1_0_12_55(__state, gpu___CG_p_patch__CG_cells__m_edge_idx, permuted_gpu___CG_p_patch__CG_cells__m_edge_idx, __f2dace_SA_edge_idx_d_0_s_cells_p_patch_2, __f2dace_SA_edge_idx_d_1_s_cells_p_patch_2, __f2dace_SA_edge_idx_d_2_s_cells_p_patch_2);
        __dace_runkernel_permute_permuted_gpu___CG_p_patch__CG_cells__m_neighbor_blk_to_gpu___CG_p_patch__CG_cells__m_neighbor_blk_map_1_1_0_12_60(__state, gpu___CG_p_patch__CG_cells__m_neighbor_blk, permuted_gpu___CG_p_patch__CG_cells__m_neighbor_blk, __f2dace_SA_neighbor_blk_d_0_s_cells_p_patch_2, __f2dace_SA_neighbor_blk_d_1_s_cells_p_patch_2, __f2dace_SA_neighbor_blk_d_2_s_cells_p_patch_2);
        __dace_runkernel_permute_permuted_gpu___CG_p_patch__CG_cells__m_neighbor_idx_to_gpu___CG_p_patch__CG_cells__m_neighbor_idx_map_1_1_0_12_65(__state, gpu___CG_p_patch__CG_cells__m_neighbor_idx, permuted_gpu___CG_p_patch__CG_cells__m_neighbor_idx, __f2dace_SA_neighbor_idx_d_0_s_cells_p_patch_2, __f2dace_SA_neighbor_idx_d_1_s_cells_p_patch_2, __f2dace_SA_neighbor_idx_d_2_s_cells_p_patch_2);
        __dace_runkernel_permute_permuted_gpu___CG_p_patch__CG_edges__m_cell_blk_to_gpu___CG_p_patch__CG_edges__m_cell_blk_map_1_1_0_12_70(__state, gpu___CG_p_patch__CG_edges__m_cell_blk, permuted_gpu___CG_p_patch__CG_edges__m_cell_blk, __f2dace_SA_cell_blk_d_0_s_edges_p_patch_4, __f2dace_SA_cell_blk_d_1_s_edges_p_patch_4, __f2dace_SA_cell_blk_d_2_s_edges_p_patch_4);
        __dace_runkernel_permute_permuted_gpu___CG_p_patch__CG_edges__m_cell_idx_to_gpu___CG_p_patch__CG_edges__m_cell_idx_map_1_1_0_12_75(__state, gpu___CG_p_patch__CG_edges__m_cell_idx, permuted_gpu___CG_p_patch__CG_edges__m_cell_idx, __f2dace_SA_cell_idx_d_0_s_edges_p_patch_4, __f2dace_SA_cell_idx_d_1_s_edges_p_patch_4, __f2dace_SA_cell_idx_d_2_s_edges_p_patch_4);
        __dace_runkernel_permute_permuted_gpu___CG_p_patch__CG_edges__m_quad_blk_to_gpu___CG_p_patch__CG_edges__m_quad_blk_map_1_1_0_12_80(__state, gpu___CG_p_patch__CG_edges__m_quad_blk, permuted_gpu___CG_p_patch__CG_edges__m_quad_blk, __f2dace_SA_quad_blk_d_0_s_edges_p_patch_4, __f2dace_SA_quad_blk_d_1_s_edges_p_patch_4, __f2dace_SA_quad_blk_d_2_s_edges_p_patch_4);
        __dace_runkernel_permute_permuted_gpu___CG_p_patch__CG_edges__m_quad_idx_to_gpu___CG_p_patch__CG_edges__m_quad_idx_map_1_1_0_12_85(__state, gpu___CG_p_patch__CG_edges__m_quad_idx, permuted_gpu___CG_p_patch__CG_edges__m_quad_idx, __f2dace_SA_quad_idx_d_0_s_edges_p_patch_4, __f2dace_SA_quad_idx_d_1_s_edges_p_patch_4, __f2dace_SA_quad_idx_d_2_s_edges_p_patch_4);
        __dace_runkernel_permute_permuted_gpu___CG_p_patch__CG_edges__m_vertex_blk_to_gpu___CG_p_patch__CG_edges__m_vertex_blk_map_1_1_0_12_90(__state, gpu___CG_p_patch__CG_edges__m_vertex_blk, permuted_gpu___CG_p_patch__CG_edges__m_vertex_blk, __f2dace_SA_vertex_blk_d_0_s_edges_p_patch_4, __f2dace_SA_vertex_blk_d_1_s_edges_p_patch_4, __f2dace_SA_vertex_blk_d_2_s_edges_p_patch_4);
        __dace_runkernel_permute_permuted_gpu___CG_p_patch__CG_edges__m_vertex_idx_to_gpu___CG_p_patch__CG_edges__m_vertex_idx_map_1_1_0_12_95(__state, gpu___CG_p_patch__CG_edges__m_vertex_idx, permuted_gpu___CG_p_patch__CG_edges__m_vertex_idx, __f2dace_SA_vertex_idx_d_0_s_edges_p_patch_4, __f2dace_SA_vertex_idx_d_1_s_edges_p_patch_4, __f2dace_SA_vertex_idx_d_2_s_edges_p_patch_4);
        __dace_runkernel_permute_permuted_gpu___CG_p_patch__CG_verts__m_cell_blk_to_gpu___CG_p_patch__CG_verts__m_cell_blk_map_1_1_0_12_100(__state, gpu___CG_p_patch__CG_verts__m_cell_blk, permuted_gpu___CG_p_patch__CG_verts__m_cell_blk, __f2dace_SA_cell_blk_d_0_s_verts_p_patch_5, __f2dace_SA_cell_blk_d_1_s_verts_p_patch_5, __f2dace_SA_cell_blk_d_2_s_verts_p_patch_5);
        __dace_runkernel_permute_permuted_gpu___CG_p_prog__m_vn_to_gpu___CG_p_prog__m_vn_map_1_1_0_12_105(__state, gpu___CG_p_prog__m_vn, permuted_gpu___CG_p_prog__m_vn, __f2dace_SA_vn_d_0_s_p_prog_7, __f2dace_SA_vn_d_2_s_p_prog_7);
        __dace_runkernel_permute_permuted_gpu___CG_p_prog__m_w_to_gpu___CG_p_prog__m_w_map_1_1_0_12_110(__state, gpu___CG_p_prog__m_w, permuted_gpu___CG_p_prog__m_w, __f2dace_SA_w_d_0_s_p_prog_7, __f2dace_SA_w_d_2_s_p_prog_7);
        __dace_runkernel_permute_permuted_gpu_z_w_con_c_to_gpu_z_w_con_c_map_1_1_0_12_115(__state, __state->__0_gpu_z_w_con_c, __state->__0_permuted_gpu_z_w_con_c, tmp_struct_symbol_1);
        __dace_runkernel_permute_permuted_gpu_z_vt_ie_to_gpu_z_vt_ie_map_1_1_0_12_120(__state, gpu_z_vt_ie, permuted_gpu_z_vt_ie, __f2dace_A_z_vt_ie_d_0_s, __f2dace_A_z_vt_ie_d_1_s, __f2dace_A_z_vt_ie_d_2_s);
        __dace_runkernel_permute_permuted_gpu_z_w_concorr_me_to_gpu_z_w_concorr_me_map_1_1_0_12_125(__state, gpu_z_w_concorr_me, permuted_gpu_z_w_concorr_me, __f2dace_A_z_w_concorr_me_d_0_s, __f2dace_A_z_w_concorr_me_d_1_s, __f2dace_A_z_w_concorr_me_d_2_s);
        __dace_runkernel_permute_permuted_gpu_cfl_clipping_to_gpu_cfl_clipping_map_1_1_0_12_130(__state, __state->__0_gpu_cfl_clipping, __state->__0_permuted_gpu_cfl_clipping, tmp_struct_symbol_14);
        __dace_runkernel_permute_permuted_gpu_z_kin_hor_e_to_gpu_z_kin_hor_e_map_1_1_0_12_135(__state, gpu_z_kin_hor_e, permuted_gpu_z_kin_hor_e, __f2dace_A_z_kin_hor_e_d_0_s, __f2dace_A_z_kin_hor_e_d_1_s, __f2dace_A_z_kin_hor_e_d_2_s);
        __dace_runkernel_permute_permuted_gpu_z_v_grad_w_to_gpu_z_v_grad_w_map_1_1_0_12_140(__state, __state->__0_gpu_z_v_grad_w, __state->__0_permuted_gpu_z_v_grad_w, tmp_struct_symbol_4, tmp_struct_symbol_5);
        __dace_runkernel_permute_permuted_gpu_zeta_to_gpu_zeta_map_1_1_0_12_145(__state, __state->__0_gpu_zeta, __state->__0_permuted_gpu_zeta, tmp_struct_symbol_8, tmp_struct_symbol_9);
        __dace_runkernel_permute_permuted_gpu_maxvcfl_arr_to_gpu_maxvcfl_arr_map_1_1_0_12_150(__state, __state->__0_gpu_maxvcfl_arr, __state->__0_permuted_gpu_maxvcfl_arr, tmp_struct_symbol_11, tmp_struct_symbol_4);
        __dace_runkernel_permute_permuted_gpu_z_ekinh_to_gpu_z_ekinh_map_1_1_0_12_155(__state, __state->__0_gpu_z_ekinh, __state->__0_permuted_gpu_z_ekinh, tmp_struct_symbol_10, tmp_struct_symbol_11);
        __dace_runkernel_permute_permuted_gpu_z_w_v_to_gpu_z_w_v_map_1_1_0_12_160(__state, __state->__0_gpu_z_w_v, __state->__0_permuted_gpu_z_w_v, tmp_struct_symbol_6, tmp_struct_symbol_7);
        __dace_runkernel_permute_permuted_gpu_levmask_to_gpu_levmask_map_1_1_0_12_165(__state, __state->__0_gpu_levmask, __state->__0_permuted_gpu_levmask, tmp_struct_symbol_13);
        __dace_runkernel_permute_permuted_gpu_z_w_con_c_full_to_gpu_z_w_con_c_full_map_1_1_0_12_170(__state, __state->__0_gpu_z_w_con_c_full, __state->__0_permuted_gpu_z_w_con_c_full, tmp_struct_symbol_2, tmp_struct_symbol_3);
    ...
    DACE_GPU_CHECK(cudaFree(permuted_gpu___CG_p_diag__m_ddt_w_adv_pc));
    ...
    DACE_GPU_CHECK(cudaFree(permuted_gpu___CG_p_metrics__m_coeff1_dwdz));
    DACE_GPU_CHECK(cudaFree(permuted_gpu___CG_p_metrics__m_coeff2_dwdz));
    ...
    DACE_GPU_CHECK(cudaFree(permuted_gpu___CG_p_patch__CG_cells__m_neighbor_blk));
    DACE_GPU_CHECK(cudaFree(permuted_gpu___CG_p_patch__CG_cells__m_neighbor_idx));
    ...
    DACE_GPU_CHECK(cudaFree(permuted_gpu___CG_p_patch__CG_verts__m_cell_blk));
...
DACE_EXPORTED velocity_no_nproma_if_prop_lvn_only_0_istep_2_state_t *__dace_init_velocity_no_nproma_if_prop_lvn_only_0_istep_2(global_data_type* global_data, t_nh_diag* p_diag, t_int_state* p_int, t_nh_metrics* p_metrics, t_patch* p_patch, t_nh_prog* p_prog, double * __restrict__ z_kin_hor_e, double * __restrict__ z_vt_ie, double * __restrict__ z_w_concorr_me, int __f2dace_A_z_kin_hor_e_d_0_s, int __f2dace_A_z_kin_hor_e_d_1_s, int __f2dace_A_z_kin_hor_e_d_2_s, int __f2dace_A_z_vt_ie_d_0_s, int __f2dace_A_z_vt_ie_d_1_s, int __f2dace_A_z_vt_ie_d_2_s, int __f2dace_A_z_w_concorr_me_d_0_s, int __f2dace_A_z_w_concorr_me_d_1_s, int __f2dace_A_z_w_concorr_me_d_2_s, int __f2dace_OA_z_kin_hor_e_d_0_s, int __f2dace_OA_z_kin_hor_e_d_1_s, int __f2dace_OA_z_kin_hor_e_d_2_s, int __f2dace_OA_z_vt_ie_d_0_s, int __f2dace_OA_z_vt_ie_d_1_s, int __f2dace_OA_z_vt_ie_d_2_s, int __f2dace_OA_z_w_concorr_me_d_0_s, int __f2dace_OA_z_w_concorr_me_d_1_s, int __f2dace_OA_z_w_concorr_me_d_2_s, double dt_linintp_ubc, double dtime, int istep, int ldeepatmo, int lvn_only, int ntnd)
{
    ...
    DACE_GPU_CHECK(cudaMalloc((void**)&__state->__0_permuted_gpu_z_v_grad_w, (((90 * tmp_struct_symbol_4) * (tmp_struct_symbol_5 - 1)) + (90 * tmp_struct_symbol_4)) * sizeof(double)));
    ...
    DACE_GPU_CHECK(cudaMalloc((void**)&__state->__0_permuted_gpu_z_w_v, (((91 * tmp_struct_symbol_6) * (tmp_struct_symbol_7 - 1)) + (91 * tmp_struct_symbol_6)) * sizeof(double)));
...
DACE_EXPORTED int __dace_exit_velocity_no_nproma_if_prop_lvn_only_0_istep_2(velocity_no_nproma_if_prop_lvn_only_0_istep_2_state_t *__state)
{
    ...
    DACE_GPU_CHECK(cudaFree(__state->__0_permuted_gpu_z_v_grad_w));
    ...
    DACE_GPU_CHECK(cudaFree(__state->__0_permuted_gpu_z_w_v));
