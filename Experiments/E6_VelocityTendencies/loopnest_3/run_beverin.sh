...
#SBATCH --exclusive
#SBATCH --chdir=.
#SBATCH --output=results/beverin/E6L3_zvgradwfull_beverin_%j.out
#SBATCH --error=results/beverin/E6L3_zvgradwfull_beverin_%j.err
#
# E6 / loopnest_3 -- z_v_grad_w direct stencil (full vertical) sweep on Beverin.
...
echo "[E6L3 beverin] host=$(hostname) threads=$OMP_NUM_THREADS data=$ICON_DATA_PATH"
...
echo "[E6L3 beverin] done. CSVs under results/beverin/"
