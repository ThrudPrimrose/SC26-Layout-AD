#!/usr/bin/env bash
#SBATCH --job-name=E6L4_ddtvnvert_daint
#SBATCH --nodes=1
...
#SBATCH --exclusive
#SBATCH --chdir=.
#SBATCH --output=results/daint/E6L4_ddtvnvert_daint_%j.out
#SBATCH --error=results/daint/E6L4_ddtvnvert_daint_%j.err
#
...
echo "[E6L4 daint] host=$(hostname) threads=$OMP_NUM_THREADS data=$ICON_DATA_PATH"
...
./bench_cpu_a results/daint/ddt_vn_vert_cpu.csv
./bench_gpu_a results/daint/ddt_vn_vert_gpu.csv
...
echo "[E6L4 daint] done. CSVs under results/daint/"
