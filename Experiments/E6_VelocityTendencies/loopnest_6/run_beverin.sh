#!/usr/bin/env bash
#SBATCH --job-name=E6L6_levelmask_beverin
#SBATCH --nodes=1
...
#SBATCH --exclusive
#SBATCH --output=results/beverin/E6L6_levelmask_beverin_%j.out
#SBATCH --error=results/beverin/E6L6_levelmask_beverin_%j.err
#
...
echo "[E6L6 beverin] host=$(hostname) threads=$OMP_NUM_THREADS data=$ICON_DATA_PATH"
...
./bench_cpu_a results/beverin/levelmask_cpu.csv
