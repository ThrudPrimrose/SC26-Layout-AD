...
ax.text(0.12+0.11, 1.01, r'$\Delta$', transform=ax.transAxes,
        ha='center', va='bottom', fontsize=10, color='#444')
ax.text(0.19+0.11, 1.04, '(Block Distance)', transform=ax.transAxes,
...
plt.tight_layout()
plt.savefig('block_access_cost_row_major.pdf', bbox_inches='tight', dpi=300)
plt.savefig('block_access_cost_row_major.png', bbox_inches='tight', dpi=300)
print("Done")