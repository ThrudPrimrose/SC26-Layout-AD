...
\item \texttt{conflict\_resolution/}: documents $T_{6.4}$.
Holds the call-frequency weighting recipe (\texttt{README.md}) and the committed \texttt{selected\_layouts.json} that the per-loopnest rankings from $T_{6.3}$ are reduced into; consumed by $T_{6.5}$.
