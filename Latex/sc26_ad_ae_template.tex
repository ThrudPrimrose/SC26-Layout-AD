...
Contribution~$C_1$ is a pen-and-paper proof with no computational artifact; the illustrative quotient-graph figures (Figures~2--3) are produced by pure-matplotlib helper scripts in the \texttt{Figures/} folder of~R1 (regenerate with \texttt{bash Figures/plot\_all.sh}; outputs land under \texttt{Figures/GeneratedFigures/}).
